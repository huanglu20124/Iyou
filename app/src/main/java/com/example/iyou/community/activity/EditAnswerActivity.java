...
public class EditAnswerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editAnswerText=(EditText)this.findViewById(R.id.edit_answer_text);
        ...
        sendPictureBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //跳转到系统图片选择界面
                SendPictureUtil.toGalleryPage(EditAnswerActivity.this);
            }
        });
        //点击删除上传图片事件
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_send:
                Editable editable= editAnswerText.getText();
                //这就是你要的编辑字符串
                String commentStr=editable.toString();
                if(AVUser.getCurrentUser() == null){
                    Toast.makeText(EditAnswerActivity.this, "请先登陆账号"+commentStr, Toast.LENGTH_SHORT).show();
                    break;
                }

                if(commentStr==null||commentStr.equals("")){
                    Toast.makeText(EditAnswerActivity.this, "请输入评论"+commentStr, Toast.LENGTH_SHORT).show();
                }
                else{

                    EditParamters par = new EditParamters();

                    String commentType = "Question";
                    ...
                    tool.senddata();
                    QuestionPostContentActivity.updateFlag=true;
//                    Toast.makeText(EditAnswerActivity.this, "发送:"+commentStr, Toast.LENGTH_SHORT).show();
