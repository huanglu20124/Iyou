...
public class RouteToActivity extends Activity implements OnMapClickListener,
OnMarkerClickListener, OnInfoWindowClickListener, InfoWindowAdapter, OnRouteSearchListener {
	...
	protected void onCreate(Bundle bundle) {
		...
		geocoderSearch2 = new GeocodeSearch(this);
//		geocoderSearch.setOnGeocodeSearchListener(this);
		geocoderSearch.setOnGeocodeSearchListener(new geoSearchListener());
		geocoderSearch2.setOnGeocodeSearchListener(new geoSearchListener2());
...
//		getIntentData();
	...
	private void registerListener() {
		aMap.setOnMapClickListener(RouteToActivity.this);
		aMap.setOnMarkerClickListener(RouteToActivity.this);
		aMap.setOnInfoWindowClickListener(RouteToActivity.this);
		aMap.setInfoWindowAdapter(RouteToActivity.this);
...
//		getLatlon((String) startSpinner.getSelectedItem());
	...
	public void getLatlon(final String name){
		...
		GeocodeQuery query = new GeocodeQuery(name, "广州");// 第一个参数表示地址，第二个参数表示查询城市，中文或者中文全拼，citycode、adcode，
		geocoderSearch.getFromLocationNameAsyn(query);// 设置同步地理编码请求
//		try {
//			geocoderSearch.getFromLocationName(query);
//			ToastUtil.show(RouteToActivity.this, "gewasagasfsdafsadgew");
...
//		}
	 ...
	 * 响应地理编码
	 */
	public void getLatlon2(final String name){
		showDialog();

		GeocodeQuery query = new GeocodeQuery(name, "广州");// 第一个参数表示地址，第二个参数表示查询城市，中文或者中文全拼，citycode、adcode，
		geocoderSearch2.getFromLocationNameAsyn(query);// 设置同步地理编码请求
//		try {
//			geocoderSearch.getFromLocationName(query);
//			ToastUtil.show(RouteToActivity.this, "gewasagasfsdafsadgew");
//		} catch (AMapException e) {
...
//						.getLatLonPoint()));
					...
					ToastUtil.show(RouteToActivity.this, addressName);
					mStartPoint=address.getLatLonPoint();
//					searchRouteResult(ROUTE_TYPE_BUS, RouteSearch.BusDefault);
				} else {
					ToastUtil.show(RouteToActivity.this, R.string.no_result);
				}
			} else {
				ToastUtil.showerror(RouteToActivity.this, rCode);
			}
		}
	}

	private class geoSearchListener2 implements GeocodeSearch.OnGeocodeSearchListener{
		@Override
		public void onRegeocodeSearched(RegeocodeResult regeocodeResult, int i) {
